...
class Reject extends Component
{
    ...
    protected $rules = [
        'sizeInput' => 'required',
        'numberingInput' => 'required|unique:output_rfts_finish,kode_numbering|unique:output_defects_finish,kode_numbering|unique:output_rejects_finish,kode_numbering',
    ];
