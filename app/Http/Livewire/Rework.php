...
class Rework extends Component
{
    ...
    protected $rules = [
        'sizeInput' => 'required',
        'numberingInput' => 'required|unique:output_rfts_finish,kode_numbering|unique:output_rejects_finish,kode_numbering',
    ];
    ...
    public function submitAllRework() {
        $allDefect = Defect::selectRaw('output_defects_finish.id id, output_defects_finish.master_plan_id master_plan_id, output_reworks_finish.kode_numbering kode_numbering, output_defects_finish.so_det_id so_det_id')->
